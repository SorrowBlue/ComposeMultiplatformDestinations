...
internal data class AllSupportType(
    ...
    val long: Long = 4,
    val longArray: LongArray = longArrayOf(5, 6, 7),
    val float: Float = 8.0f,
    val floatArray: FloatArray = floatArrayOf(9.0f, 10.0f, 11.0f),
    val boolean: Boolean = true,
    val booleanArray: BooleanArray = booleanArrayOf(false, true),
    val string: String = "Hello",
    val arrayString: Array<String> = arrayOf("World", "Kotlin"),
    val listInt: List<Int> = listOf(12, 13, 14),
    val listLong: List<Long> = listOf(15L, 16L, 17L),
    val listFloat: List<Float> = listOf(18.0f, 19.0f, 20.0f),
    val listBoolean: List<Boolean> = listOf(true, false),
    val listString: List<String> = listOf("Kotlin", "Compose"),
    val serializableType: SerializableType = SerializableType(21),
